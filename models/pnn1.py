...
import pdb
from models.pytorch_utils import do_mixup, interpolate, pad_framewise_output
...
class LeeNet11(nn.Module):
    def __init__(self, in_channel, classes_num):
        ...
        self.conv_block1 = LeeNetConvBlock(in_channel, 64, 3, 3)
...
class Res1dNet31(nn.Module):
    def __init__(self, in_channel, classes_num):    
        ...
        self.conv0 = nn.Conv1d(in_channels=in_channel, out_channels=64, kernel_size=1, stride=1, padding=0, bias=False)
        self.bn0 = nn.BatchNorm1d(64)

        self.resnet = _ResNetWav1d(_ResnetBasicBlockWav1d, [2, 3, 4, 3, 2, 2, 2])
    ...
    def forward(self, input, mixup_lambda=None):
        ...
        # return output_dict
class Res1dNet311(nn.Module):
    def __init__(self, in_channel, classes_num):    
        super(Res1dNet311, self).__init__()

        self.conv0 = nn.Conv1d(in_channels=in_channel, out_channels=64, kernel_size=7, stride=3, padding=3, bias=False)
        self.bn0 = nn.BatchNorm1d(64)
...
class Res1dNet51(nn.Module):
    def __init__(self,  in_channel, classes_num):
        ...
        self.conv0 = nn.Conv1d(in_channels=in_channel, out_channels=64, kernel_size=11, stride=5, padding=5, bias=False)
        self.bn0 = nn.BatchNorm1d(64)
